...
class _odlm(object):
    ...
    def _autoNoise(self):
        ...
        if self.options.useAutoNoise:
            trimmed_data = [x for _, x in self.data.items() if x is not None]
    ...
    def _forwardFilter(self,
        ...
        for step in range(start, end + 1):
            ...
            # ELIMINAMOS EL PASO QUE ACABAMOS DE FILTRAR
            # WARNING: SI SE REQUIERE ESTE DATO MAS ADELANTE, PROBLEMA
            del self.data[step]
